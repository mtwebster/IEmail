...
public abstract class EmailContent {
    ...
    public static final class Message extends EmailContent implements SyncColumns, MessageColumns {
         ...
         * (non-Javadoc)
         * @see com.mwebster.iemaildon.provider.EmailContent#save(android.content.Context)
         */
        @Override
        public Uri save(Context context) {
    ...
    public static final class Account extends EmailContent implements AccountColumns, Parcelable {
         ...
         * {@code content://com.mwebster.iemaildon.provider/account/UUID} format, which is safe to use
         * for desktop shortcuts.
         *
         * <p>We don't want to store _id in shortcuts, because
         * {@link com.mwebster.iemaildon.AccountBackupRestore} won't preserve it.
         */
        ...
        /**
         * Parse {@link Uri} in the {@code content://com.mwebster.iemaildon.provider/account/ID} format
