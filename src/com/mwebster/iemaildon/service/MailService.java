...
package com.mwebster.iemaildon.service;
...
import com.mwebster.iemaildon.activity.MessageList;
...
public class MailService extends Service {
    ...
    private static final String ACTION_CHECK_MAIL =
        "com.mwebster.iemaildon.intent.action.MAIL_SERVICE_WAKEUP";
    private static final String ACTION_RESCHEDULE =
        "com.mwebster.iemaildon.intent.action.MAIL_SERVICE_RESCHEDULE";
    private static final String ACTION_CANCEL =
        "com.mwebster.iemaildon.intent.action.MAIL_SERVICE_CANCEL";
    private static final String ACTION_NOTIFY_MAIL =
        "com.mwebster.iemaildon.intent.action.MAIL_SERVICE_NOTIFY";

    private static final String EXTRA_CHECK_ACCOUNT = "com.mwebster.iemaildon.intent.extra.ACCOUNT";
    private static final String EXTRA_ACCOUNT_INFO = "com.mwebster.iemaildon.intent.extra.ACCOUNT_INFO";
    private static final String EXTRA_DEBUG_WATCHDOG = "com.mwebster.iemaildon.intent.extra.WATCHDOG";
    private static final String EXTRA_MAILBOX_ID = "com.mwebster.iemaildon.intent.extra.MAILBOX_ID";
