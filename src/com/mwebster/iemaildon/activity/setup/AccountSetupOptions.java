...
import com.mwebster.iemaildon.mail.store.ExchangeStore;
...
public class AccountSetupOptions extends Activity implements OnClickListener {
    ...
    private static final int SYNC_WINDOW_EAS_DEFAULT = com.mwebster.iemaildon.Account.SYNC_WINDOW_3_DAYS;
