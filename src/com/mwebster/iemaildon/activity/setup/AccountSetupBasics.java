...
import com.mwebster.iemaildon.VendorPolicyLoader;
import com.mwebster.iemaildon.activity.Debug;
...
public class AccountSetupBasics extends Activity
    ...
    private final static String EXTRA_ACCOUNT = "com.mwebster.iemaildon.AccountSetupBasics.account";
    public final static String EXTRA_EAS_FLOW = "com.mwebster.iemaildon.extra.eas_flow";

    // Action asking us to return to our original caller (i.e. finish)
    private static final String ACTION_RETURN_TO_CALLER =
        "com.mwebster.iemaildon.AccountSetupBasics.return";
    ...
    private static final String ACTION_START_AT_MESSAGE_LIST =
        "com.mwebster.iemaildon.AccountSetupBasics.messageList";

    private final static String EXTRA_USERNAME = "com.mwebster.iemaildon.AccountSetupBasics.username";
    private final static String EXTRA_PASSWORD = "com.mwebster.iemaildon.AccountSetupBasics.password";

    private final static int DIALOG_NOTE = 1;
    private final static int DIALOG_DUPLICATE_ACCOUNT = 2;

    private final static String STATE_KEY_PROVIDER =
        "com.mwebster.iemaildon.AccountSetupBasics.provider";
