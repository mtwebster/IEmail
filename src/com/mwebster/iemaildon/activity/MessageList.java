...
import com.mwebster.iemaildon.activity.setup.AccountSecurity;
import com.mwebster.iemaildon.activity.setup.AccountSettings;
...
public class MessageList extends ListActivity implements OnItemClickListener, OnClickListener,
    ...
    private static final String STATE_SELECTED_ITEM_TOP =
        "com.mwebster.iemaildon.activity.MessageList.selectedItemTop";
    private static final String STATE_SELECTED_POSITION =
        "com.mwebster.iemaildon.activity.MessageList.selectedPosition";
