...
public class MailService extends Service {
    ...
    private static final String ACTION_CHECK_MAIL =
        "com.mwebster.email.intent.action.MAIL_SERVICE_WAKEUP";
    private static final String ACTION_RESCHEDULE =
        "com.mwebster.email.intent.action.MAIL_SERVICE_RESCHEDULE";
    private static final String ACTION_CANCEL =
        "com.mwebster.email.intent.action.MAIL_SERVICE_CANCEL";
    private static final String ACTION_NOTIFY_MAIL =
        "com.mwebster.email.intent.action.MAIL_SERVICE_NOTIFY";

    private static final String EXTRA_CHECK_ACCOUNT = "com.mwebster.email.intent.extra.ACCOUNT";
    private static final String EXTRA_ACCOUNT_INFO = "com.mwebster.email.intent.extra.ACCOUNT_INFO";
    private static final String EXTRA_DEBUG_WATCHDOG = "com.mwebster.email.intent.extra.WATCHDOG";
    private static final String EXTRA_MAILBOX_ID = "com.mwebster.email.intent.extra.MAILBOX_ID";
