...
import com.mwebster.email.Controller;
import com.mwebster.email.Email;
import com.mwebster.email.EmailAddressAdapter;
import com.mwebster.email.EmailAddressValidator;
...
import com.mwebster.email.mail.internet.EmailHtmlUtil;
...
import com.mwebster.email.provider.EmailContent.BodyColumns;
import com.mwebster.email.provider.EmailContent.Message;
import com.mwebster.email.provider.EmailContent.MessageColumns;
import com.mwebster.exchange.provider.GalEmailAddressAdapter;
...
public class MessageCompose extends Activity implements OnClickListener, OnFocusChangeListener {
    private static final String ACTION_REPLY = "com.mwebster.email.intent.action.REPLY";
    private static final String ACTION_REPLY_ALL = "com.mwebster.email.intent.action.REPLY_ALL";
    private static final String ACTION_FORWARD = "com.mwebster.email.intent.action.FORWARD";
    private static final String ACTION_EDIT_DRAFT = "com.mwebster.email.intent.action.EDIT_DRAFT";

    private static final String EXTRA_ACCOUNT_ID = "account_id";
    private static final String EXTRA_MESSAGE_ID = "message_id";
    private static final String STATE_KEY_CC_SHOWN =
        "com.mwebster.email.activity.MessageCompose.ccShown";
    private static final String STATE_KEY_BCC_SHOWN =
        "com.mwebster.email.activity.MessageCompose.bccShown";
    private static final String STATE_KEY_QUOTED_TEXT_SHOWN =
        "com.mwebster.email.activity.MessageCompose.quotedTextShown";
    private static final String STATE_KEY_SOURCE_MESSAGE_PROCED =
        "com.mwebster.email.activity.MessageCompose.stateKeySourceMessageProced";
    private static final String STATE_KEY_DRAFT_ID =
        "com.mwebster.email.activity.MessageCompose.draftId";
