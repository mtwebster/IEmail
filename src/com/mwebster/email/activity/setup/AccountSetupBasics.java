...
import com.mwebster.email.activity.Debug;
import com.mwebster.email.activity.MessageList;
import com.mwebster.email.activity.setup.AccountSettingsUtils.Provider;
...
public class AccountSetupBasics extends Activity
    ...
    private final static String EXTRA_ACCOUNT = "com.mwebster.email.AccountSetupBasics.account";
    public final static String EXTRA_EAS_FLOW = "com.mwebster.email.extra.eas_flow";

    // Action asking us to return to our original caller (i.e. finish)
    private static final String ACTION_RETURN_TO_CALLER =
        "com.mwebster.email.AccountSetupBasics.return";
    ...
    private static final String ACTION_START_AT_MESSAGE_LIST =
        "com.mwebster.email.AccountSetupBasics.messageList";

    private final static String EXTRA_USERNAME = "com.mwebster.email.AccountSetupBasics.username";
    private final static String EXTRA_PASSWORD = "com.mwebster.email.AccountSetupBasics.password";

    private final static int DIALOG_NOTE = 1;
    private final static int DIALOG_DUPLICATE_ACCOUNT = 2;

    private final static String STATE_KEY_PROVIDER =
        "com.mwebster.email.AccountSetupBasics.provider";
