...
import com.mwebster.email.activity.setup.AccountSecurity;
import com.mwebster.email.activity.setup.AccountSettings;
...
public class MessageList extends ListActivity implements OnItemClickListener, OnClickListener,
    ...
    private static final String STATE_SELECTED_ITEM_TOP =
        "com.mwebster.email.activity.MessageList.selectedItemTop";
    private static final String STATE_SELECTED_POSITION =
        "com.mwebster.email.activity.MessageList.selectedPosition";
