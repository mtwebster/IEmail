...
import com.mwebster.iemail.activity.setup.AccountSecurity;
...
public class MessageList extends ListActivity implements OnItemClickListener, OnClickListener,
    ...
    private static final String EXTRA_MAGIC_ID = "com.mwebster.iemail.activity.MAGIC_ID";
    ...
    private static final String STATE_FOLDER_LIST_NAMES =
        "com.mwebster.iemail.activity.MessageList.foldernames";
    private static final String STATE_FOLDER_LIST_VALS =
        "com.mwebster.iemail.activity.MessageList.foldervals";
